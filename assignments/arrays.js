...
function carModels(a, b) {
    const car_modelA = a.car_model; 
    const car_modelB = b.car_model;

    let carModels = 0;
    if (car_modelA > car_modelB) {
        carModels = 1;
    } else if (car_modelA < car_modelB) {
        carModels = -1;
    }
    return carModels;
}

console.log (inventory.sort(carModels));
